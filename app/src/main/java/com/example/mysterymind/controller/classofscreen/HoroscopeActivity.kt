...
class HoroscopeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            val selectedDateStr = currentDate.format(DateTimeFormatter.ofPattern("MM/dd")) // Рядок дати у форматі "dd/MM"
           Log.d("ABOBA",selectedDateStr)
        ...
        rootView.setOnTouchListener { _, touchEvent ->
            when (touchEvent.action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    Log.d("HoroscopeActivity", "Text swiped. Current index: $currentIndex") // Логування події
                }
